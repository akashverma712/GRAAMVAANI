    ...
    <section className="py-12 px-4 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {stories.map((story, index) => (
          ...
          >
            <img src={story.image} alt={t(story.title)} className="w-full h-48 object-cover" />
            <div className="p-4">

              <h3 className="text-xl font-semibold text-green-800">{t(story.title)}</h3>
              ...
              <p className="text-sm text-gray-600 mt-1">
                {t('stories.by')} {story.name} {t('stories.from')} {story.village}
              </p>

              <p className="text-gray-700 mt-2 line-clamp-3">{t(story.description)}</p>
      ...
      {selected && (
        ...
        >
          ...
          >
            ...
            <img src={selected.image} alt={t(selected.title)} className="w-full h-48 object-cover rounded" />
            <h3 className="text-2xl font-bold mt-4 text-green-800">{t(selected.title)}</h3>
            <p className="text-sm text-gray-600 mb-1">
              {t('stories.by')} {selected.name} {t('stories.from')} {selected.village}
            </p>
            <p className="text-gray-700 mt-2">{t(selected.description)}</p>
