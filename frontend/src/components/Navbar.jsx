		...
		<motion.header
			...
			<div className="max-w-6xl mx-auto flex justify-between items-center px-4 py-3">
				...
				<nav className="hidden sm:flex gap-6 items-center text-sm font-medium">
					<NavItem to="/notice" active={isActive('/notice')} icon={<FaBell />} label={t('navbar.features')} />
					<NavItem to="/Forum" active={isActive('/Forum')} icon={<FaComments />} label={t('navbar.about')} />
					<NavItem to="/scheme" active={isActive('/scheme')} icon={<FaUserShield />} label={t('navbar.contact')} />
				</nav>
			...
			<AnimatePresence>
				{isMobileMenuOpen && (
					...
					>
						<NavItem to="/notice" active={isActive('/notice')} icon={<FaBell />} label={t('navbar.features')} mobile />
						<NavItem to="/Forum" active={isActive('/Forum')} icon={<FaComments />} label={t('navbar.about')} mobile />
						<NavItem to="/scheme" active={isActive('/scheme')} icon={<FaUserShield />} label={t('navbar.contact')} mobile />
						<SignedOut>
							<SignInButton>
