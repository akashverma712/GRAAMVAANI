...
const helpContacts = [
  {
    ...
    description: "For medical emergencies, vaccination, and health guidance.",
  },
  {
    id: 2,
    category: "Education",
    ...
    description: "For school enrolment, scholarship, and literacy programs.",
  },
  {
    id: 3,
    ...
    description: "For crop guidance, loans, and farmer schemes.",
  },
  {
    id: 4,
    category: "Emergency",
    ...
    description: "Fire, flood, accident, or any urgent issue.",
  },
];

const HelpSupport = () => {
  return (
    <section className="max-w-6xl mx-auto px-4 my-6 py-12 bg-gray-50 rounded-xl">
      <motion.h2
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {helpContacts.map((contact, idx) => (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">{contact.category}</h3>
